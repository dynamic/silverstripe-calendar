<%-- Calendar Filter Form - Simplified traditional form template.
     Designed to be used within an external collapse container.
     Requires Bootstrap 5+ for form styling classes. --%>
<form $AttributesHTML class="calendar-filter-form" aria-label="Filter calendar events">
    <div class="row g-3">
        <!-- Search Field -->
    ...
    <div class="d-flex gap-2 mt-3">
        ...
        <% if $HasActiveFilters && $ClearFiltersLink %>
            <a href="$ClearFiltersLink.ATT" class="btn btn-outline-danger" role="button" aria-label="Remove all filters and show all events">
